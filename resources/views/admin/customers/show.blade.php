...
<div class="py-6">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('admin.customers.index') }}" class="text-red-600 hover:text-red-500 flex items-center">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-2xl font-semibold text-gray-900">£{{ number_format($stats['average_order'], 2) }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white overflow-hidden shadow rounded-lg">
                <div class="p-5">
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                <dt class="text-sm font-medium text-gray-500 truncate">Customer Since</dt>
                                <dd class="text-2xl font-semibold text-gray-900">{{ $user->created_at->format('M Y') }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
                ...
                <dl class="sm:divide-y sm:divide-gray-200">
                    ...
                    <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                        ...
                        <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                            {{ $stats['first_order'] ? $stats['first_order']->format('M d, Y h:i A') : 'No orders yet' }}
                        </dd>
                    </div>
                    <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                        <dt class="text-sm font-medium text-gray-500">Last Order</dt>
                        <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                            {{ $stats['last_order'] ? $stats['last_order']->format('M d, Y h:i A') : 'No orders yet' }}
                        </dd>
                    </div>
                </dl>
            </div>
        ...
        <div class="mt-8">
            <div class="sm:flex sm:items-center">
                <div class="sm:flex-auto">
                    ...
                    <p class="mt-2 text-sm text-gray-700">A list of all orders made by this customer.</p>
                </div>
            </div>
